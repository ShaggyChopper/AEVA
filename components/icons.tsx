...
export const GlobeAltIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A11.953 11.953 0 0 1 12 13.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0a11.978 11.978 0 0 1-2.818 2.58m-10.05 0A11.978 11.978 0 0 1 12 16.5c2.998 0 5.74-1.1 7.843-2.918m-15.686 0A8.959 8.959 0 0 0 3 12c0-.778.099-1.533.284-2.253m0 0a11.978 11.978 0 0 0 2.818 2.58m10.05 0A11.978 11.978 0 0 0 12 16.5c-2.998 0-5.74-1.1-7.843-2.918" />
  </svg>
);

export const Cog6ToothIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.26.716.53 1.003l.824.824c.42.42.657.98.657 1.573v1.905c0 .593-.237 1.153-.657 1.573l-.824.824c-.27.287-.467.629-.53 1.003l-.213 1.281c-.09.543-.56.941-1.11.941h-2.594c-.55 0-1.02-.398-1.11-.941l-.213-1.281c-.063-.374-.26-.716-.53-1.003l-.824-.824c-.42-.42-.657-.98-.657-1.573v-1.905c0-.593.237-1.153.657-1.573l.824-.824c.27-.287.467-.629.53-1.003l.213-1.281Z" />
...
export const PiggyBankIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 14.25v2.25m3-3.75v3.75m3-2.25v2.25m3-3.75v3.75M3 13.5c0-1.657 1.343-3 3-3h12c1.657 0 3 1.343 3 3v6c0 1.657-1.343 3-3 3H6c-1.657 0-3-1.343-3-3v-6Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6.75h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm-3-3h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm0-3h.008v.008h-.008v-.008Zm-3 3h.008v.008h-.008v-.008Zm0-3h.008v.008h-.008v-.008Z" />
    </svg>
);
...
export const ScaleIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0 0 12 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52a26.285 26.285 0 0 0-3-.52m0 0V3m-3.75 2.013A26.285 26.285 0 0 1 12 4.5c-2.291 0-4.545.16-6.75.47M12 4.5v15.75m0 0a26.283 26.283 0 0 1-3.75 2.013m3.75-2.013a26.283 26.283 0 0 0 3.75 2.013M6.75 12a26.28 26.28 0 0 0-3.75-2.013v4.026a26.28 26.28 0 0 0 3.75-2.013Zm-3.75 0a26.285 26.285 0 0 1 3.75-2.013m0 4.026a26.285 26.285 0 0 0-3.75-2.013m0 0c-.013.004-.027 0-.04 0m1.125.004a3.738 3.738 0 0 1-1.125 0M18.75 12a26.28 26.28 0 0 0-3.75-2.013v4.026a26.28 26.28 0 0 0 3.75-2.013Zm-3.75 0a26.285 26.285 0 0 1 3.75-2.013m0 4.026a26.285 26.285 0 0 0-3.75-2.013m0 0c-.013.004-.027 0-.04 0m1.125.004a3.738 3.738 0 0 1-1.125 0" />
  </svg>
);

export const ReceiptPercentIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-1.5h5.25m-5.25 0h5.25m-5.25 0h5.25m-5.25 0h5.25M3 13.5v-2.25A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v2.25m-18 0a2.25 2.25 0 0 0 2.25 2.25h13.5A2.25 2.25 0 0 0 21 13.5m-18 0v-2.25" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.91 11.625a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0V9.75M5.625 11.625a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0V9.75M10.5 11.625a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0V9.75" />
    </svg>
);
